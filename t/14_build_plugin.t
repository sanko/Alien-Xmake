...
# Alien::Build ties %ENV{@PATH} and unshifts its bin_dir entries for every hook;
# when a harness starts us without PATH defined that unshift warns in vendor Env.pm.
